...
document.getElementById('unit-toggle')?.addEventListener('click', () => {
  ...
  // Re-fetch the weather for the last selected establishment
...
export async function updateWeather(lat, lng) {
  ...
  try {
    ...
    forecastContainer.innerHTML = ''; // Always clear it before repopulating
    ...
    forecastDays.forEach((day) => {
      ...
      console.log(`Forecast: ${dayName} - ${dayCondition}`);
